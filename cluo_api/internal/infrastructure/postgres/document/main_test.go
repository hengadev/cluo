...
import (
	...
	"github.com/hengadev/cluo_api/internal/infrastructure/postgres/document"
...
func TestMain(m *testing.M) {
	...
	repo = documentRepository.New(testPool)
	versionRepo = documentRepository.NewVersionRepository(testPool)
