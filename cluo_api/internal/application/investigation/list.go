...
func (s *CaseService) List(ctx context.Context, r *investigation.ListCasesRequest) (*investigation.ListCasesResponse, error) {
	// Validate request
...
func caseMatchesFilter(caseDecrypted *investigation.Investigation, filter investigation.Filter) bool {
	// Filter by status
