...
func TestUpdateCase(t *testing.T) {
	...
	t.Run("Unauthorized", func(t *testing.T) {
		...
		retrievedCase, err := caseDomain.DecryptCaseEncx(ctx, crypto, retrievedCaseEncx)
	...
	t.Run("MultipleCases", func(t *testing.T) {
		...
		response1 := caseDomain.CaseResponse{}
		...
		retrievedCase2, err := caseDomain.DecryptCaseEncx(ctx, crypto, retrievedCase2Encx)
		require.NoError(t, err)
