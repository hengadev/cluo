...
ALTER TABLE estimates ADD CONSTRAINT IF NOT EXISTS chk_estimates_positive_total
    CHECK (estimated_total >= 0);

ALTER TABLE estimates ADD CONSTRAINT IF NOT EXISTS chk_estimates_acceptance_logic
    CHECK (
