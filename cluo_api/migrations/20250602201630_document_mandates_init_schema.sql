...
ALTER TABLE mandates ADD CONSTRAINT IF NOT EXISTS chk_mandates_date_logic
    CHECK (valid_from >= issue_date);

ALTER TABLE mandates ADD CONSTRAINT IF NOT EXISTS chk_mandates_valid_until_logic
    CHECK (
