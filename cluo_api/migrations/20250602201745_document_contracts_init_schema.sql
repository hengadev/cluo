...
ALTER TABLE contracts ADD CONSTRAINT IF NOT EXISTS chk_contracts_date_logic
    CHECK (
        end_date IS NULL OR
        end_date > start_date
    );

ALTER TABLE contracts ADD CONSTRAINT IF NOT EXISTS chk_contracts_positive_value
    CHECK (
