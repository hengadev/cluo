...
<div
    class="flex gap-4 border rounded-card p-3 bg-muted/30 transition-all {isDragging
        ? 'opacity-50'
        : ''} {isDragOver
...
>
    ...
    <!-- Remove Button -->
    <button
        class="self-start p-1 text-muted-foreground hover:text-destructive transition-colors rounded-md hover:bg-destructive/10"
