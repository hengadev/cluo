<script lang="ts">
    ...
    // TODO: use a better function for the filtering thing
...
>
    <div class="relative">
        ...
        <Combobox.Input
            ...
            class="h-input rounded-9px border-border-input bg-background placeholder:text-foreground-alt/50 focus:ring-foreground focus:ring-offset-background focus:outline-hidden inline-flex w-[600px] truncate border px-11 text-base transition-colors focus:ring-2 focus:ring-offset-2 sm:text-sm"
            placeholder="Chercher une affaire"
            aria-label="Chercher une affaire"
        />
        <Combobox.Trigger
